...
import 'package:dailynotes/screens/NoteScreen.dart';
...
class LockScreenForBoom extends StatefulWidget {
  const LockScreenForBoom({super.key});

  @override
  State<LockScreenForBoom> createState() => _LockScreenForBoomState();
}

class _LockScreenForBoomState extends State<LockScreenForBoom> {
